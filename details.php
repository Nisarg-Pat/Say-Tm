...
<div style="text-align:center; color:black">
    <h1 style="font-size:50px ">Order Confirmed</h1><hr>
    </div>
...
<td align="center" style="width:400px">  <a href="cancel.php?eid=<?php echo $re->boid ?>"><button class="lin" style=" border:1px solid black;padding: 10px;width: 200px;font-size: 20px;border-radius: 5px">Cancel Order</button></a></td>
</table>
<!--
